<div class="gridContainer">
    ...
    <div class="gridHeader">
        ...
        <table class="gridTable" cellspacing="0">
                <tr>
                    ...
                    <td class="gridHeaderCell" style="width:auto;"><A href="javascript:sortNotes('note_text');">Note</A><span ID="arrow_note_text" class="sortSymbol">{note_text_sort}</span></td>
                </tr>
        </table>
    </div>
   ...
   <div class="gridLeftLink" style="margin-top:4px">
    ...
    <!-- START BLOCK : prev_page_link -->
        ...
        <A href="javascript:getPrevPssage();">&lt;&lt;Back</A>
