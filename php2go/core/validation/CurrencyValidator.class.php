...
// +----------------------------------------------------------------------+
//
// $Header: /www/cvsroot/php2go/core/validation/CurrencyValidator.class.php,v 1.1 2005/01/24 17:36:55 mpont Exp $
...
class CurrencyValidator extends Validator
{
	...
	function execute(&$value) {
		...
		if ($result === FALSE && isset($this->fieldLabel)) {
			...
			$this->errorMessage = PHP2Go::getLangVal('ERR_FORM_FIELD_INVALID_INPUT', array($this->fieldLabel, $maskLabels['CURRENCY']));
		}
		return $result;		
	}	
