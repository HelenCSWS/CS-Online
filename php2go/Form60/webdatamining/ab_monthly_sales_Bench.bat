...
wget --post-file=ab_sales_bench.txt --referer="http://lcb.liquorconnect.ca/lc/liis.nsf/Report_Selector/409D5234C9F4B577872578480076CD2B?OpenDocument&val=3355764" --cookies=on --load-cookies=cookie.txt --keep-session-cookies --save-cookies=cookie.txt "http://lcb.liquorconnect.ca/lc/liis.nsf/Report_Selector/409D5234C9F4B577872578480076CD2B?OpenDocument&val=3355764"

del ab_sales_bench.html
ren "409D5234C9F4B577872578480076CD2B@OpenDocument&val=3355764" ab_sales_bench.html
del LCAGTP.NSF
del cookie.txt


copy ab_sales_bench.html ..\reports\ab_sales_bench.html /Y
