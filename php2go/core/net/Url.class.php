...
// +----------------------------------------------------------------------+
//
// $Header: /www/cvsroot/php2go/core/net/Url.class.php,v 1.15 2005/06/17 19:34:14 mpont Exp $
// $Date: 2005/06/17 19:34:14 $
...
class Url extends PHP2Go
{
	...
	// @access		public
	// @param		nem string			Nome do parâmetro
	// @return		void
	//!-----------------------------------------------------------------
	...
	// @note		Para utilizar o valor da requisição atual, utilize
	//				$_SERVER['QUERY_STRING'] ou $_SERVER['REQUEST_URI']
	//				como parâmetro
	// @see			Url::encode
