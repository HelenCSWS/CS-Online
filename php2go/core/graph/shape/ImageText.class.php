...
// +----------------------------------------------------------------------+
//
// $Header: /www/cvsroot/php2go/core/graph/shape/ImageText.class.php,v 1.1 2005/08/30 14:57:16 mpont Exp $
...
class ImageText extends Drawable 
{
	...
	var $vertical = FALSE;	// @var verical bool	"FALSE" Orientaчуo do texto: horizontal (FALSE) ou vertical (TRUE)
