   ...
   <div style=" width:650px; border:0px solid black;margin-left:auto;margin-right:auto; font-family:'Century Gothic'; font-size:9pt">
        ...
        <div style="float:left; width:100%; margin-left:auto;margin-right:auto;text-align:center;padding-top:15px; ">
            <table  class="table_inv_info">
                <tr class="tr_title" ><td style="width:50px;">Qty</td><td>Description</td><!--td>Order#</td--><td>Unit Price</td><td>Line Total</td></tr>
...
<!-- END BLOCK : loop_line -->
  <tr style="font-weight:normal;">
              ...
              <tr style="font-weight:normal; display:{isDisc}">
                    <td ></td>
                    <td ></td>
                     <td class="td_right_algin">Discount Price</td>
        ...
        <div style="float:left; padding-top:3px;width:100%; text-align:center;">Make all cheques payable to Christopher Stewart Wine & Spirits</div>
