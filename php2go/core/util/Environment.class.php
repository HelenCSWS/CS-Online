...
// +----------------------------------------------------------------------+
//
// $Header: /www/cvsroot/php2go/core/util/Environment.class.php,v 1.10 2005/07/20 22:30:50 mpont Exp $
// $Date: 2005/07/20 22:30:50 $
...
class Environment extends PHP2Go
{
	...
	function get($key) {
		...
		if (@getenv($key))
        {
		  if($key=="username")  // if control name is usernmae, default value will be servers computer name, force to set to "";
            return "";
          else
        	return getenv($key);
        }
