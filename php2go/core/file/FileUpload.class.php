...
// +----------------------------------------------------------------------+
//
// $Header: /www/cvsroot/php2go/core/file/FileUpload.class.php,v 1.14 2005/07/20 22:29:45 mpont Exp $
...
class FileUpload extends PHP2Go
{
	...
	function addHandler($fieldName, $savePath, $saveName='', $mode=0644, $callback=NULL) {
		$newHandler = array('field'=>$fieldName, 'save_path'=>$savePath, 'save_name'=>$saveName, 'save_mode'=>$mode, 'error'=>'');
