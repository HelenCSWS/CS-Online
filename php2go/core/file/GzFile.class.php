...
// +----------------------------------------------------------------------+
//
// $Header: /www/cvsroot/php2go/core/file/GzFile.class.php,v 1.10 2005/01/21 17:20:01 mpont Exp $
...
class GzFile extends FileCompress
{
	...
	function extractData($data) {
		$header = unpack("H2a/H2b/Cflags", StringUtils::strLeft($data, 3));
		$descriptor = unpack("Vcrc/Vsize", StringUtils::strRight($data, 8));
