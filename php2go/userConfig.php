...
// +----------------------------------------------------------------------+
//
// $Header: /www/cvsroot/php2go/userConfig.php,v 1.24 2005/08/30 18:51:05 mpont Exp $
// $Date: 2005/08/30 18:51:05 $
// $Revision: 1.24 $
 ...
 */
$P2G_USER_CFG['ABSOLUTE_URI'] = 'http://' . $_SERVER['SERVER_NAME'] . '/php2go/';
 ...
 * 	 AFTERCONNECT: callback function that must be invoked right after the connection establishment
 * 	 BEFORECLOSE: callback function that must be invoked before the connection is closed
 * }
