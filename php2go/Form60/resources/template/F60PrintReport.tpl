...
<tr><td style="padding-top:20px" valign="top">
    ...
    <table width="95%" cellpadding="0" cellspacing="0" border="0" align="center">
      <tr style="display:block">
        <td colspan="2" width="100%" align="right" class="cellA">{page_links}</td>
      </tr>
      <tr style="display:block">
    ...
    <!--tr><td align="right" style="padding-right:25px;padding-top:20px"><INPUT onClick="closePage()" ID="btnClose" NAME="btnClose" TYPE="BUTTON" VALUE="Close" CLASS="btnOK" ></td></tr-->
    </table>
</td></tr>
