...
==========================================
	...
	Requirements:
		PHP 4.1.0 or higher (including PHP5)
	...
	Summary:
		...
		using the discussion forum at http://php2go.sourceforge.net/forum/.
		
	Download:
		You can get the newest version of the framework and the documentation files at
		the project website: http://php2go.sourceforge.net.
	...
	Demo applications:
		...
		of the framework. Visit http://php2go.sourceforge.net and choose "Online Demos" in the left menu.
