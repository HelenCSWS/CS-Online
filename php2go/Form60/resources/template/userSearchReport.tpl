...
<table width="625" cellpadding="4" cellspacing="4" border="0" align="center">
  <tr>
    <td width="50%" align="left" class="cellA">{row_count}</td>
    <td width="50%" align="right" class="cellA">{rows_per_page}</td>
  </tr>
  <tr>
    <td width="50%" align="left" class="cellA">{go_to_page}</td>
    <td width="50%" align="right" class="cellA">{page_links}</td>
  </tr>
</table>	

<table width="625" cellpadding="4" cellspacing="0" border="9" bordercolor="#999999" align="center">
...
<table width="625" cellpadding="4" cellspacing="4" border="0" align="center">
  ...
  <tr>
    <td width="50%" align="left" class="cellA">{this_page}</td>
    <td width="50%" align="right" class="cellA">{row_interval}</td>
  </tr>
</table>
