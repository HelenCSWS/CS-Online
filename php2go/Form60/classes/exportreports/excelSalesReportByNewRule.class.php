...
//       Licensee#	Customer		Store type	City	Address
		...
		if($commissionType==2 ||$commissionType==3)// BCLDB; 3: bcldb and licensee for vancouver island and orkanagon team
		{
        ...
        if($commissionType==3)
        {
                ...
                array("data"=>$cellValue_3, "format"=>$columnHeaderLeft), 
              	...
              	array("data"=>"", "format"=>$columnHeaderLeft), 
              	array("data"=>"", "format"=>$columnHeaderLeft),
               	array("data"=>"Case value - ALL", "format"=>$columnHeaderLeft),              	
              	array("data"=>"Case value - Less BCLDB", "format"=>$columnHeaderLeft),            
