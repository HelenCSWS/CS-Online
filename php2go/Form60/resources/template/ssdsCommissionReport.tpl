...
<!-- END BLOCK : next_page_link -->
	...
	<table  width="99%"  cellpadding="0" cellspacing="0" border="0">
        <tr bgcolor="#7F9DB9">
             ...
             <td nowrap class="mlcolheader" width="100"><A href="javascript:sortMarketList('contact_name','{statusid}');">Contact</A><span ID='arrow_contact_name_{statues_id}' class="sortSymbol-C">{contact_name_sort}</span></td>
...
<!-- START BLOCK : loop_line -->
        <tr class='ml{row_style}'>
            ...
            <td nowrap class="CPgridrowCell" valign="middle" {contact_name_updcolor} title="{contact_name_t}">{contact_name}</td>
