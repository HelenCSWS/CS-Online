...
// +----------------------------------------------------------------------+
//
// $Header: /www/cvsroot/php2go/core/data/adapter/DataSetDb.class.php,v 1.3 2005/09/01 20:02:17 mpont Exp $
// $Date: 2005/09/01 20:02:17 $
...
//				$dataset =& DataSet::getInstance('db', array('connectionId' => 'CONN_ID'));
...
class DataSetDb extends DataAdapter
{
	...
	function loadSubSet($offset, $size, $stmt, $bindVars=FALSE, $isProcedure=FALSE, $cursorName=NULL) {
		...
		if ($isProcedure) {
			...
			$this->totalRecordCount = $Db->getCount($stmt, $bindVars);
