...
// +----------------------------------------------------------------------+
//
// $Header: /www/cvsroot/php2go/core/net/CurlClient.class.php,v 1.12 2005/07/20 22:28:58 mpont Exp $
...
class CurlClient extends PHP2Go 
{
	...
	function CurlClient() {
		...
		parent::registerDestructor($this, '_CurlClient');
	}
	
	//!-----------------------------------------------------------------
	// @function	CurlClient::_CurlClient
	// @desc		Destrutor do objeto, fecha a sessão se a mesma for mantida aberta
	// @access		public
	// @return		void
	//!-----------------------------------------------------------------
	function _CurlClient() {
		$this->close();
	}
