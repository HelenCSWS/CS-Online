...
// +----------------------------------------------------------------------+
//
// $Header: /www/cvsroot/php2go/core/util/Callback.class.php,v 1.7 2005/08/30 13:58:27 mpont Exp $
// $Date: 2005/08/30 13:58:27 $
...
class Callback extends PHP2Go
{
	...
	function invokeByRef(&$argument) {
		if ($this->isValid())
			return call_user_func($this->function, &$argument);
		return NULL;
	}
	...
	function toString() {
		if (isset($this->function))
			return (TypeUtils::isArray($this->function) ? (TypeUtils::isObject($this->function[0]) ? get_class($this->function[0]) . '=>' . $this->function[1] : $this->function[0] . '=>' . $this->function[1]) : $this->function);
		return NULL;
	}
