...
/**
 * Lista de modificadores utilizados para transformaчуo de variсveis de substituiчуo em templates
 *
 * As funчѕes sуo definidas da seguinte maneira:
 *  - string simples: funчуo procedural
 *  - array com 1 posiчуo: funчуo procedural
 *  - array com 2 posiчѕes: chamada de mщtodo estсtico cuja classe jс foi importada
 *  - array com 3 posiчѕes: chamada de mщtodo estсtico contendo o caminho da classe na primeira posiчуo
 * Formatos fora desses padrѕes irуo gerar um erro de interpretaчуo do template
 *
 * $Revision: 1.2 $
 */
