...
// +----------------------------------------------------------------------+
//
// $Header: /www/cvsroot/php2go/core/base/Php2GoError.class.php,v 1.22 2005/08/30 14:21:11 mpont Exp $
// $Date: 2005/08/30 14:21:11 $
...
class PHP2GoError extends PHP2Go
{
	...
	// @return		void
	// @see 		PHP2GoError::setMessage
	// @see 		PHP2GoError::setType
	//!-----------------------------------------------------------------
	...
	// @desc 		Verifica se o log dos erros ocorridos est?habilitado
	// @access 		public
	// @return		bool
	// @static	
	//!-----------------------------------------------------------------
	...
	// @access		public
	// @return		bool
	// @see			PHP2GoError::debugVars
	// @static	
	//!-----------------------------------------------------------------
	function debugTrace() {
		return (function_exists('debug_backtrace') && TypeUtils::isTrue(PHP2Go::getConfigVal('DEBUG_TRACE', FALSE)));
	}
	...
	// @desc		Verifica se o erro ?do tipo E_STRICT, introduzido no
	//				PHP 5 para informar trechos de código que devem ser
	//				alterados para se adaptar ?Zend Engine 2
	...
	// @desc		Verifica se o erro disparado ?um erro da família E_USER
	// @param		errorCode int	Código do erro disparado
	// @access		public	
	// @return		bool
	//!-----------------------------------------------------------------
	...
	// @note		O nome do arquivo ser?processado pela função strftime para substituir
	...
	//!-----------------------------------------------------------------
	function handle() {
		if ($this->type != E_STRICT && !$this->isIgnoreError($this->msg)) {
				...
				<table width='100%' cellpadding='6' cellspacing='0' border='1' bordercolor='#ff0000' bgcolor='#efefef'>
					<tr><td>
						<table border='0' cellpadding='2' cellspacing='0' width='100%'>
						   	...
						   	<tr><td style='font-family:Arial;font-size:15px'>An error has occurred, please close down your browser and try again later.</td></tr>
						</table>
					</td></tr>
				</table>");
		}
	...
	*/
	...
	// @return 		string Informações sobre o sistema para serem registradas junto ?mensagem de erro
	// @access 		private	
	//!-----------------------------------------------------------------
