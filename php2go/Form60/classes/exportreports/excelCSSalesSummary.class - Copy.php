...
class excelCSSalesSummary 
{
	...
	function excelCSSalesSummary ()
	{
        ...
        $this->columns = array("A"=>array("index"=>0, "width"=>10), 
                                ...
                                "H"=>array("index"=>7, "width"=>9),
                                "I"=>array("index"=>8, "width"=>9),
                                "J"=>array("index"=>9, "width"=>13),
                                "K"=>array("index"=>10, "width"=>13),
           ...
           else
           {
                ...
                else
                {
                    ...
                    $values = array(
                                	...
                                	array("data"=>"=SUM(K$startUserRow:K$endUserRow)","format"=>$CalibriNormalCurrencyRed),	
		 ...
		 $values = array(
            ...
            // country total
            	$values = array(array("data"=>"", "format"=>$CalibriNormalNoBorder),  
		                        ...
		                        array("data"=>"Bermar", "format"=>$columnHeaderRight),
