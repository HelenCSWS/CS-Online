...
// +----------------------------------------------------------------------+
//
// $Header: /www/cvsroot/php2go/core/validation/RegexValidator.class.php,v 1.7 2005/01/24 16:08:58 mpont Exp $
...
class RegexValidator extends Validator
{
	...
	function execute($value) {
		...
		if ($result === FALSE && isset($this->fieldLabel))
			$this->errorMessage = PHP2Go::getLangVal('ERR_FORM_FIELD_REGEX', $this->fieldLabel);
		return $result;		
	}	
