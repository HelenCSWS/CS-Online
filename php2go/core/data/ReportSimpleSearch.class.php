...
// +----------------------------------------------------------------------+
//
// $Header: /www/cvsroot/php2go/core/data/ReportSimpleSearch.class.php,v 1.13 2005/08/30 14:29:32 mpont Exp $
// $Date: 2005/08/30 14:29:32 $
...
class ReportSimpleSearch extends AbstractList
{
	...
	function _checkRequest() {
		...
		$this->searchSent = (!empty($this->fields) && !empty($this->operators) && !empty($this->values) && !empty($this->mainOperator));			
	}
