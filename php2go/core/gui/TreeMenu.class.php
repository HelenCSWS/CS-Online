...
// +----------------------------------------------------------------------+
//
// $Header: /www/cvsroot/php2go/core/gui/TreeMenu.class.php,v 1.9 2005/01/21 17:20:02 mpont Exp $
...
class TreeMenu extends Menu
{
	...
	//!-----------------------------------------------------------------
	function _buildCode() {
		$this->_Document->addScript(PHP2GO_JAVASCRIPT_PATH . "ext/cooljstree/cooltree.js");
    	$this->menuCode .= "<SCRIPT TYPE=\"text/javascript\">\n";
