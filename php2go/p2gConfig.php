...
// $Revision: 1.46 $
	...
	// {{{
	// }}} Inclui e instancia os módulos de inicialização e configuração do framework
	...
	// {{{
	// }}} Variáveis de inicialização do PHP
	...
	// {{{
	// }}} Registra a função de destruição dos objetos
