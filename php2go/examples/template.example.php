<?
	// $Header: /www/cvsroot/php2go/examples/template.example.php,v 1.6 2005/07/22 19:08:49 mpont Exp $
	// $Revision: 1.6 $
	// $Date: 2005/07/22 19:08:49 $
	...
	$tpl->assign('text_links', 'Visit the PHP2Go website: http://php2go.sourceforge.net');
	$tpl->assign('mail', 'mpont@users.sourceforge.net');
	$tpl->assign('number', 1956.456);
	$tpl->assign('file', __FILE__);
	$tpl->assign('img', 'http://php2go.sourceforge.net/resources/images/p2g_transp_logo_header.gif');
