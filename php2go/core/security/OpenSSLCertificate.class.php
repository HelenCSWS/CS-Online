...
// +----------------------------------------------------------------------+
//
// $Header: /www/cvsroot/php2go/core/security/OpenSSLCertificate.class.php,v 1.8 2005/06/08 22:16:15 mpont Exp $
...
{	
	...
	function OpenSSLCertificate($path) {
		...
		parent::registerDestructor($this, '_OpenSSLCertificate');
	}
	
	//!-----------------------------------------------------------------
	// @function	OpenSSLCertificate::_OpenSSLCertificate
	// @desc		Destrutor da classe
	// @access		public
	//!-----------------------------------------------------------------
	function _OpenSSLCertificate() {
