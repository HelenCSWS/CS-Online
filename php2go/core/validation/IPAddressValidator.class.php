...
// +----------------------------------------------------------------------+
//
// $Header: /www/cvsroot/php2go/core/validation/IPAddressValidator.class.php,v 1.8 2005/01/24 16:08:58 mpont Exp $
...
class IPAddressValidator extends Validator
{
	...
	function execute($value) {
		...
		if ($result === FALSE && isset($this->fieldLabel)) {
			...
			$this->errorMessage = PHP2Go::getLangVal('ERR_FORM_FIELD_INVALID_INPUT', array($this->fieldLabel, $maskLabels['IP']));
		}
		return $result;
