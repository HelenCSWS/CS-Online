...
// +----------------------------------------------------------------------+
//
// $Header: /www/cvsroot/php2go/core/graph/Image.class.php,v 1.1 2005/08/30 14:57:16 mpont Exp $
...
class Image extends PHP2Go
{
	...
	function Image($handle) {
		...
		PHP2Go::registerDestructor($this, '_Image');
	}
	...
	function getTransparency() {
		...
		return array($color['red'], $color['green'], $green['blue']);
	}
