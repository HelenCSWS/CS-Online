...
// +----------------------------------------------------------------------+
//
// $Header: /www/cvsroot/php2go/core/validation/DateValidator.class.php,v 1.9 2005/08/30 14:05:31 mpont Exp $
// $Date: 2005/08/30 14:05:31 $
...
class DateValidator extends Validator
{
	...
	function execute(&$value) {
		...
		if ($result === FALSE && isset($this->fieldLabel)) {
			...
			$this->errorMessage = PHP2Go::getLangVal('ERR_FORM_FIELD_INVALID_INPUT', array($this->fieldLabel, $maskLabels['DATE']));
		}
		return $result;		
	}	
