...
// +----------------------------------------------------------------------+
//
// $Header: /www/cvsroot/php2go/core/LanguageBase.class.php,v 1.11 2005/07/25 13:41:02 mpont Exp $
// $Date: 2005/07/25 13:41:02 $
...
{	
	...
	function getLanguageValue($key, $params=NULL) {
		...
		if ($value) {
			if ($params !== NULL)
				return (TypeUtils::isArray($params) ? vsprintf($value, $params) : sprintf($value, $params));
			else
				return $value;
		}
		return NULL;
