...
// +----------------------------------------------------------------------+
//
// $Header: /www/cvsroot/php2go/core/base/Php2Go.class.php,v 1.26 2005/08/30 14:06:47 mpont Exp $
// $Date: 2005/08/30 14:06:47 $
...
class PHP2Go
{
	var $objectName; 	// @var objectName string		Nome da classe do objeto
	...
	function isA($className, $recurse=TRUE) {
		if ($recurse)
			return (strtolower(get_class($this)) == strtolower($className) || (is_subclass_of($this, $className)));
		else
         	return (strtolower(get_class($this)) == strtolower($className));
	}
	...
	// @desc		Cria uma cópia do objeto atual
	// @access		public
	// @return		object Cópia do objeto atual
	//!-----------------------------------------------------------------	
